import SizeController from '@/actions/App/Http/Controllers/Setting/SizeController';
...
export default function SizeIndex({ sizes, filters }) {
    ...
    function handleSearch(e) {
        e.preventDefault();
        router.get(SizeController.index.url(), { search }, { preserveState: true, replace: true });
    }

    function handleDelete() {
        router.delete(SizeController.destroy.url(deleting.id), {
            ...
            render: (row) => (
                <div className="flex justify-end gap-2">
                    <Button size="sm" variant="outline" asChild>
                        <Link href={SizeController.edit.url(row.id)}>
        ...
        <>
            ...
            <div className="p-6">
                <div className="mb-5 flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href={SizeController.create.url()}>
