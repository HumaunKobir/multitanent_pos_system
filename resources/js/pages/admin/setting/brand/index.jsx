...
const routes = settingRoutes('brand');
const PERM = 'setting.brand';

export default function BrandIndex({ brands, filters }) {
            ...
            <div className="px-2 py-1">
                <div className="mb-3 flex items-center justify-between rounded-lg bg-blue-950 px-5 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-base font-semibold text-white">Brands</h1>
                            <p className="text-xs text-white/60">Manage your product brands.</p>
                        </div>
                    </div>
                ...
                <div className="mb-4 flex flex-wrap items-end gap-2">
                    ...
                    <ListDateExportBar
                        ...
                        exportExcelRoute="setting.brand.export-excel"
                        exportPdfRoute="setting.brand.export-pdf"
                        exportPrintRoute="setting.brand.export-print"
                        query={{ search }}
                    />
                </div>

                <DataTable columns={columns} rows={brands.data} rowKey="id" emptyMessage="No brands found." />
            ...
            <Dialog open={!!deleting} onOpenChange={(open) => !open && setDeleting(null)}>
                <DialogContent className="p-0">
                    <div className="flex items-center gap-2.5 bg-blue-950 px-5 py-3">
                        ...
                        <h2 className="text-sm font-semibold text-white">Delete Brand</h2>
                    </div>
