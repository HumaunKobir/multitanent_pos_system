...
export default function WarrantyIndex({ warranties, filters }) {
    ...
    function handleSearch(e) {
        e.preventDefault();
        router.get(WarrantyController.index.url(), { search }, { preserveState: true, replace: true });
    }

    function handleDelete() {
        router.delete(WarrantyController.destroy.url(deleting.id), {
            ...
            render: (row) => (
                <div className="flex justify-end gap-2">
                    <Button size="sm" variant="outline" asChild>
                        <Link href={WarrantyController.edit.url(row.id)}>
        ...
        <>
            ...
            <div className="p-6">
                <div className="mb-5 flex items-center justify-between">
                    ...
                    <Button asChild>
                        <Link href={WarrantyController.create.url()}>
