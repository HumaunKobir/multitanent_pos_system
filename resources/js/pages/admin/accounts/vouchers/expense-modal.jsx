...
export default function ExpenseVoucherModal({ open, onOpenChange, item, accountsPicker, assetAccounts, contacts, defaults }) {
    ...
    return (
        <VoucherModalShell
            ...
            title={isEditing ? 'Edit Expense Voucher' : 'Create Expense Voucher'}
                ...
                <div className="rounded-lg border p-3">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <Input className="mt-1" value={form.data.credit_description} onChange={(e) => form.setData('credit_description', e.target.value)} placeholder="Payment account narration" />
                        </div>
                    </div>
                </div>
                <div>
