...
import { ArrowLeft, CalendarDays, HandCoins, MessageSquare, Package, Plus, Save, Search, Trash2 } from 'lucide-react';
    ...
    return (
        <div ref={ref} className="relative">
            ...
            >
                {selected ? (
                    <span>
                        {selected.name} <span className="text-muted-foreground">({selected.phone})</span>
                    </span>
                ) : (
...
export default function PurchaseEdit({ purchase, suppliers }) {
    const form = useForm({
