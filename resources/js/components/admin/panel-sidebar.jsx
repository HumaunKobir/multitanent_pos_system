...
import { BusinessSessionControls } from '@/components/admin/business-session-controls';
...
export function MobileSidebarTrigger() {
    ...
    return (
        <div className="sticky top-0 z-30 flex shrink-0 items-center justify-between gap-2 border-b border-border bg-background px-3 py-2">
            <Button variant="outline" size="icon" className="size-8 shrink-0" onClick={toggle}>
                <Menu className="size-4" />
                <span className="sr-only">Open sidebar</span>
            </Button>
            <BusinessSessionControls compact className="min-w-0 flex-1 justify-end" />
        </div>
    );
}
