...
<body>
  ...
  <script>
    function fitBarcode(wrap) {
      ...
      if (tw > w && w > 0) {
        var scale = w / tw;
        el.style.fontSize = Math.max(18, Math.floor(baseHeight * scale)) + 'px';
      }
