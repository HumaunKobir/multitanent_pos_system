...
class PlaceOnlineOrder
{
    ...
    public function execute(
        ...
        return DB::transaction(function () use (
            ...
            if ($transactionId === null && $paymentMethod === 'sslcommerz') {
                $order->update([
                    'transaction_id' => $this->generateTransactionId($order->id),
                ]);
            }
    ...
    public function generateTransactionId(int $orderId): string
    {
        return 'CP-'.$orderId.'-'.strtoupper(Str::random(8));
    }
}
