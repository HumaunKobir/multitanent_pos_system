import{n as e,s as t,t as n}from"./jsx-runtime-6_rQPNQF.js";import{t as r}from"./compiler-runtime-BEUpNReH.js";import{c as i,n as a,r as o,u as s}from"./dist-CcZGCiug.js";import{t as c}from"./arrow-left-C7XwQ9dW.js";import{t as l}from"./receipt-ZGkKilbQ.js";import{t as ee}from"./square-pen-r9tgp4Kz.js";import{t as te}from"./trash-2-BK9H6i-7.js";import{F as ne,N as re,O as u,v as d,x as f}from"./app-h5sRSi6U.js";import{a as ie,i as ae,n as oe,o as se,r as ce,s as le,t as ue}from"./dialog-Xjv1yeyO.js";import{t as de}from"./use-can-QIl-Lrda.js";import{t as fe}from"./can-Snm6M_WQ.js";import{i as pe,n as me,r as he,t as ge}from"./invoice-show-layout-DTEeB1So.js";var _e=r();function p(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function m(e){return parseFloat(e??0).toFixed(2)}function h(e){let t=parseFloat(e??0);return Number.isInteger(t)?String(t):t.toFixed(2)}function ve({companyName:e,logoUrl:t,branchName:n,invoiceNumber:r,date:i,customer:a,products:o,totals:s,footer:c=`Powered by Coolness Point`}){try{let l=a?.name?.trim()||`Walk-in Customer`,ee=a?.phone?.trim()||``,te=a?.address?.trim()||``,ne=o.map(e=>`
            <tr class="service">
                <td>${p(e.name)}</td>
                <td>${p(e.variant||``)}</td>
