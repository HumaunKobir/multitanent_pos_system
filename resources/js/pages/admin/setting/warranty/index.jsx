...
const routes = settingRoutes('warranty');
const PERM = 'setting.warranty';

export default function WarrantyIndex({ warranties, filters }) {
    ...
    const columns = [
        {
            id: 'num',
            header: '#',
            render: (_, i) => (warranties.from ?? 0) + i,
        },
        { header: 'Name', accessorKey: 'name' },
        {
            id: 'duration',
            header: 'Duration',
            render: (row) => row.duration ?? <span className="text-xs text-muted-foreground">—</span>,
        },
        {
            id: 'status',
            header: 'Status',
            ...
            <div className="px-2 py-1">
                <div className="mb-3 flex items-center justify-between rounded-lg bg-blue-950 px-5 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-base font-semibold text-white">Warranties</h1>
                            <p className="text-xs text-white/60">Manage your product warranties.</p>
                        </div>
                    </div>
                ...
                <DataTable columns={columns} rows={warranties.data} rowKey="id" emptyMessage="No warranties found." />

                {warranties.links?.length > 3 && (
            ...
            <Dialog open={!!deleting} onOpenChange={(open) => !open && setDeleting(null)}>
                <DialogContent className="p-0">
                    <div className="flex items-center gap-2.5 bg-blue-950 px-5 py-3">
                        ...
                        <h2 className="text-sm font-semibold text-white">Delete Warranty</h2>
                    </div>
