    ...
    return (
        <>
            ...
            <div className="px-2 py-1">
                <div className="mb-3 flex items-center justify-between rounded-lg bg-blue-950 px-5 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/60">Manage product color variants.</p>
                        </div>
                    </div>
                ...
                <div className="mb-4 flex flex-wrap items-end gap-2">
                    ...
                    <ListDateExportBar
                        ...
                        exportExcelRoute="setting.color.export-excel"
                        exportPdfRoute="setting.color.export-pdf"
                        exportPrintRoute="setting.color.export-print"
                        query={{ search }}
                    />
                </div>
            ...
            <SettingFormDialog
                ...
                routes={routes}
                fields={[
                    { name: 'name', label: 'Name', placeholder: 'Color name', required: true },
