...
const defaultDescription =
    'We bring you quality products, reliable delivery, and a shopping experience built on trust. Every order is handled with care — from selection to your doorstep.';

export default function About({ content, heroImage }) {
        ...
        <FrontendLayout>
            ...
            <section className="relative min-h-[200px] overflow-hidden bg-store-primary sm:min-h-[260px] lg:min-h-[300px]">
                ...
                <div className="relative store-container flex min-h-[inherit] flex-col justify-center py-10 sm:py-12">
                    ...
                    <p className="mt-3 max-w-lg text-sm leading-relaxed text-white/80 sm:text-base">
                        Style, quality, and service — everything you need in one trusted store.
                    </p>
                </div>
            </section>
            ...
            <section className="store-container py-10 sm:py-12">
                <div className="max-w-3xl">
                    <h2 className="text-lg font-bold text-store-primary sm:text-xl">Our story</h2>
                    ...
                    <div className="mt-5">
                        {content ? (
                            ...
                            <p className="text-[15px] leading-relaxed text-store-muted sm:text-base">
                                {defaultDescription}
                            </p>
                        )}
                    </div>
