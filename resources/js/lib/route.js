const routes = {
    ...
    'branch-panel.subscription-suspended': '/branch-panel/subscription-suspended',
    login: '/login',
    register: '/register',
    logout: '/logout',
    ...
    'setting.category.export-excel': '/setting/category/export/excel',
    'setting.category.export-pdf': '/setting/category/export/pdf',
    'setting.category.export-print': '/setting/category/export/print',
    ...
    'setting.brand.export-excel': '/setting/brand/export/excel',
    'setting.brand.export-pdf': '/setting/brand/export/pdf',
    'setting.brand.export-print': '/setting/brand/export/print',
    ...
    'setting.size.export-excel': '/setting/size/export/excel',
    'setting.size.export-pdf': '/setting/size/export/pdf',
    'setting.size.export-print': '/setting/size/export/print',
    ...
    'setting.color.export-excel': '/setting/color/export/excel',
    'setting.color.export-pdf': '/setting/color/export/pdf',
    'setting.color.export-print': '/setting/color/export/print',
    ...
    'setting.business-setup.edit': '/setting/business-setup',
    'setting.business-setup.update': '/setting/business-setup',
    'setting.business-setup.branch.update': '/setting/business-setup/branch/:branch',
    'setting.business-setup.branch.renew': '/setting/business-setup/branch/:branch/renew',
    'setting.business-setup.branch.payments': '/setting/business-setup/branch/:branch/payments',
    'branch-clients.index': '/branch-clients',
    'branch-clients.update': '/branch-clients/:branch',
    'branch-clients.renew': '/branch-clients/:branch/renew',
    'branch-clients.payments': '/branch-clients/:branch/payments',
    'branch-clients.invoices': '/branch-clients/:branch/invoices',
    'branch-clients.security-deposit': '/branch-clients/:branch/security-deposit',
    'branch-clients.security-deposits': '/branch-clients/:branch/security-deposits',
    'branch-panel.subscription.index': '/branch-panel/subscription',
    'branch-panel.subscription.pay': '/branch-panel/subscription/pay',
    'branch-panel.subscription.invoices': '/branch-panel/subscription/invoices',
    'branch-panel.subscription.security-deposits': '/branch-panel/subscription/security-deposits',
    'branch.index': '/branch',
    'branch.store': '/branch',
    ...
    'product.export-excel': '/product/export/excel',
    'product.export-pdf': '/product/export/pdf',
    'product.export-print': '/product/export/print',
    'product.create': '/product/create',
    'product.store': '/product',
    'product.edit': '/product/:product/edit',
    'product.update': '/product/:product',
    'product.destroy': '/product/:product',
    'product.photo.destroy': '/product-photo/:productPhoto',
    ...
    'inventory.purchase.export-excel': '/inventory/purchase/export/excel',
    'inventory.purchase.export-pdf': '/inventory/purchase/export/pdf',
    'inventory.purchase.export-print': '/inventory/purchase/export/print',
    ...
    'inventory.purchase-return.export-excel': '/inventory/purchase-return/export/excel',
    'inventory.purchase-return.export-pdf': '/inventory/purchase-return/export/pdf',
    'inventory.purchase-return.export-print': '/inventory/purchase-return/export/print',
    ...
    'inventory.damage.export-excel': '/inventory/damage/export/excel',
    'inventory.damage.export-pdf': '/inventory/damage/export/pdf',
    'inventory.damage.export-print': '/inventory/damage/export/print',
    'inventory.stock-adjustment.index': '/inventory/stock-adjustment',
    'inventory.stock-adjustment.create': '/inventory/stock-adjustment/create',
    'inventory.stock-adjustment.store': '/inventory/stock-adjustment',
    'inventory.stock-adjustment.show': '/inventory/stock-adjustment/:stock_adjustment',
    'inventory.stock-adjustment.destroy': '/inventory/stock-adjustment/:stock_adjustment',
    'inventory.stock-adjustment.export-excel': '/inventory/stock-adjustment/export/excel',
    'inventory.stock-adjustment.export-pdf': '/inventory/stock-adjustment/export/pdf',
    'inventory.stock-adjustment.export-print': '/inventory/stock-adjustment/export/print',
    ...
    'inventory.stock-distribution.send-return': '/inventory/stock-distribution/:stock_distribution/send-return',
    'inventory.stock-distribution.receive-return': '/inventory/stock-distribution/:stock_distribution/receive-return',
    ...
    'inventory.stock-distribution.export-excel': '/inventory/stock-distribution/export/excel',
    'inventory.stock-distribution.export-pdf': '/inventory/stock-distribution/export/pdf',
    'inventory.stock-distribution.export-print': '/inventory/stock-distribution/export/print',
    ...
    'inventory.sale-return.refund': '/inventory/sale-return/:sale_return/refund',
    ...
    'inventory.product-exchange.payment': '/inventory/product-exchange/:product_exchange/payment',
    ...
    'party.parties.index': '/party/parties',
    'party.parties.store': '/party/parties',
    'party.parties.update': '/party/parties/:party',
    'party.parties.destroy': '/party/parties/:party',
    ...
    'party.supplier.export-excel': '/party/supplier/export/excel',
    'party.supplier.export-pdf': '/party/supplier/export/pdf',
    'party.supplier.export-print': '/party/supplier/export/print',
    ...
    'party.supplier-payment.export-excel': '/party/supplier-payment/export/excel',
    'party.supplier-payment.export-pdf': '/party/supplier-payment/export/pdf',
    'party.supplier-payment.export-print': '/party/supplier-payment/export/print',
    ...
    'report.inventory-stock.export-excel': '/report/inventory-stock/export/excel',
    'report.inventory-stock.export-pdf': '/report/inventory-stock/export/pdf',
    'report.inventory-stock.export-print': '/report/inventory-stock/export/print',
    'report.stock-valuation': '/report/stock-valuation',
    'report.stock-aging': '/report/stock-aging',
    'report.opening-stock': '/report/opening-stock',
    ...
    'report.sales-report.export-excel': '/report/sales-report/export/excel',
    ...
    'report.subscription-billing': '/report/subscription-billing',
    'report.subscription-billing.export-excel': '/report/subscription-billing/export/excel',
    'report.subscription-billing.export-csv': '/report/subscription-billing/export/csv',
    'report.subscription-billing.export-pdf': '/report/subscription-billing/export/pdf',
    'report.subscription-billing.export-print': '/report/subscription-billing/export/print',
...
const methods = {
    ...
    'branch-clients.update': 'put',
    'branch-clients.renew': 'post',
    'branch-clients.security-deposit': 'post',
    'branch-panel.subscription.pay': 'post',
    'branch.store': 'post',
    'branch.update': 'patch',
    ...
    'inventory.stock-adjustment.store': 'post',
    'inventory.stock-adjustment.destroy': 'delete',
    'inventory.stock-distribution.store': 'post',
    'inventory.stock-distribution.receive': 'post',
    'inventory.stock-distribution.send-return': 'post',
    'inventory.stock-distribution.receive-return': 'post',
