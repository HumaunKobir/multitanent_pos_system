            ...
            <div className="px-2 py-1">
                <div className="mb-4 flex items-center justify-between rounded-lg bg-blue-950 px-5 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-base font-semibold text-white">Branch Profile</h1>
                            <p className="text-xs text-white/60">Update your branch details and login credentials.</p>
                        </div>
                    </div>
                    <Button type="submit" form="branch-profile-form" disabled={processing} className="bg-emerald-600 hover:bg-emerald-700">
                        <Save className="size-4" />
                        {processing ? 'Saving...' : 'Save Profile'}
                    </Button>
                </div>

                <form id="branch-profile-form" onSubmit={submit} className="space-y-4">
                    <SettingsSection title="Branch Information" description="Shown on POS receipts and branch documents.">
                        <FormField label="Branch name" name="name" required error={errors.name}>
                    ...
                    <SettingsSection title="Login Account" description="Update your email and password for this branch account.">
