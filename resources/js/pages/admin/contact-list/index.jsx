...
const routes = {
    ...
    destroy: (id) => route('contact-list.destroy', { subscriber: id }),
};
...
export default function ContactListIndex({ subscribers, filters }) {
            ...
            <div className="px-2 py-1">
                <div className="mb-3 flex items-center justify-between rounded-lg bg-blue-950 px-5 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-base font-semibold text-white">Contact List</h1>
                            <p className="text-xs text-white/60">Newsletter subscribers from your store.</p>
                        </div>
                    </div>
                </div>
            ...
            <Dialog open={!!deleting} onOpenChange={(open) => !open && setDeleting(null)}>
                <DialogContent className="p-0">
                    <div className="flex items-center gap-2.5 bg-blue-950 px-5 py-3">
                        ...
                        <h2 className="text-sm font-semibold text-white">Delete Subscriber</h2>
                    </div>
                    <div className="px-5 pb-5 pt-4">
                        <p className="text-sm text-muted-foreground">
                            Are you sure you want to delete <strong>{deleting?.email}</strong>? This action cannot be undone.
                        </p>
