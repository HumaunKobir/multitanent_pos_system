import{n as e,s as t,t as n}from"./jsx-runtime-6_rQPNQF.js";import{t as r}from"./compiler-runtime-BEUpNReH.js";import{c as i,n as a,r as o,u as s}from"./dist-CcZGCiug.js";import{t as c}from"./arrow-left-C7XwQ9dW.js";import{t as l}from"./receipt-DtlaclVd.js";import{t as u}from"./square-pen-BXdCvGw8.js";import{t as ee}from"./trash-2-CxV5opYv.js";import{F as te,N as ne,O as re,v as d,x as f}from"./app-tP4fNUvE.js";import{a as ie,i as ae,n as oe,o as se,r as ce,s as le,t as ue}from"./dialog-q4Qk4q0T.js";import{t as de}from"./use-can-DOrCKzqZ.js";import{t as fe}from"./can-DDflHVwp.js";import{i as pe,n as me,r as he,t as ge}from"./invoice-show-layout-9W8RqU5E.js";var _e=r();function p(e){return String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function m(e){return parseFloat(e??0).toFixed(2)}function h(e){let t=parseFloat(e??0);return Number.isInteger(t)?String(t):t.toFixed(2)}function ve({companyName:e,logoUrl:t,branchName:n,invoiceNumber:r,date:i,customer:a,products:o,totals:s,footer:c=`Powered by Coolness Point`}){try{let l=a?.name?.trim()||`Walk-in Customer`,u=a?.phone?.trim()||``,ee=a?.address?.trim()||``,te=o.map(e=>`
            <tr class="service">
                <td>${p(e.name)}</td>
                <td>${p(e.variant||``)}</td>
