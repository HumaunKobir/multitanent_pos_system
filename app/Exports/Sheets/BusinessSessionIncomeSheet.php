...
class BusinessSessionIncomeSheet implements FromCollection, ShouldAutoSize, WithEvents, WithHeadings, WithTitle
{
    ...
    {
        return ['Category', 'Account', 'Transactions', 'Total Amount'];
    }
