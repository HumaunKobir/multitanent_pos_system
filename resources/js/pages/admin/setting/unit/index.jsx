import UnitController from '@/actions/App/Http/Controllers/Setting/UnitController';
...
export default function UnitIndex({ units, filters }) {
    ...
    function handleSearch(e) {
        e.preventDefault();
        router.get(UnitController.index.url(), { search }, { preserveState: true, replace: true });
    }

    function handleDelete() {
        router.delete(UnitController.destroy.url(deleting.id), {
    ...
    return (
        <>
            ...
            <div className="p-6">
                ...
                <DataTable columns={columns} rows={units.data} rowKey="id" emptyMessage="No units found." />
