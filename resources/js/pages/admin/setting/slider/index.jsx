...
import { GalleryHorizontal, Pencil, Plus, Search, Trash2 } from 'lucide-react';
...
export default function SliderIndex({ sliders, filters }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) =>
                row.image ? (
                    <img src={`/storage/${row.image}`} alt={row.name} className="h-10 w-16 rounded object-cover" />
                ) : (
    ...
    return (
        <>
            ...
            <div className="px-2 py-1">
                <div className="mb-3 flex items-center justify-between rounded-lg bg-blue-950 px-5 py-3">
                    <div className="flex items-center gap-3">
                        <div className="flex size-8 items-center justify-center rounded-md bg-white/15">
                            <GalleryHorizontal className="size-4 text-white" />
                        </div>
                        <div>
                            <h1 className="text-base font-semibold text-white">Sliders</h1>
                ...
                <DataTable columns={columns} rows={sliders.data} rowKey="id" emptyMessage="No sliders found." />
            ...
            <Dialog open={!!deleting} onOpenChange={(open) => !open && setDeleting(null)}>
                <DialogContent className="p-0">
                    <div className="flex items-center gap-2.5 bg-blue-950 px-5 py-3">
                        ...
                        <h2 className="text-sm font-semibold text-white">Delete Slider</h2>
                    </div>
